...
class DETRLoss(nn.Module):
    ...
    def _get_loss_class(self, pred_scores, targets, gt_scores, num_gts, postfix=''):
        ...
        if self.fl:  # FocalLoss
            if num_gts and self.vfl:  # VarifocalLoss
    ...
    def _get_loss_bbox(self, pred_bboxes, gt_bboxes, postfix=''):
        ...
        loss[name_giou] = 1.0 - bbox_inner_iou(pred_bboxes, gt_bboxes, xywh=True, GIoU=True, ratio=1.25)
    ...
    def _get_loss_aux(self,
        ...
        if match_indices is None and self.use_uni_match:
            match_indices = self.matcher(pred_bboxes[self.uni_match_ind],
                                         ...
                                         gt_mask=gt_mask)
        for i, (aux_bboxes, aux_scores) in enumerate(zip(pred_bboxes, pred_scores)):  # i = 0,1,2
