...
class PECA(nn.Module):
    def __init__(self, channels) -> None:
        ...
        self.conv_1 = Conv(channels, channels, 1)
        self.conv_2 = Conv(channels, channels, 1)
        self.conv_3 = Conv(channels, channels, 1)
        self.pool_h = nn.AdaptiveAvgPool2d((None, 1))
        self.pool_w = nn.AdaptiveAvgPool2d((1, None))
        self.conv_hw = Conv(channels, channels, (1, 1))
    ...
    def forward(self, x):
        ...
        x_pool_h = self.conv_1(x_pool_h)
        x_pool_w = self.conv_2(x_pool_w)
